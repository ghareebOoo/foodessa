...
import image from "../../../public/src/assets/admin/login.png"
            ...
            <div className='w-full md:px-4'>
                ...
                {!showLogin &&  <form onSubmit={formikRegister.handleSubmit} className='mt-3'>
                    ...
                    <div className='w-full md:max-w-[450px] flex flex-col gap-1'>
                        ...
                        <input name='name' value={formikRegister.values.name} onBlur={formikRegister.handleBlur} onChange={formikRegister.handleChange} type='text' className='w-full bg-primary rounded-md border-[1px] border-gray-50 px-2 py-1' placeholder='Name'/>
                    ...
                    <div className='w-full md:max-w-[450px] mt-1 flex flex-col gap-1'>
                        <label className='text-tertiary font-normal text-base'>Email</label>
                        <input type='email' name='email' value={formikRegister.values.email} onBlur={formikRegister.handleBlur} onChange={formikRegister.handleChange} className='w-full bg-primary rounded-md border-[1px] border-gray-50 px-2 py-1' placeholder='Email'/>
                    ...
                    <div className='w-full md:max-w-[450px] mt-1 flex flex-col gap-1'>
                        <label className='text-tertiary font-normal text-base'>Password</label>
                        <input type='password' name='password' value={formikRegister.values.password} onBlur={formikRegister.handleBlur} onChange={formikRegister.handleChange} className='w-full bg-primary rounded-md border-[1px] border-gray-50 px-2 py-1' placeholder='Password'/>
                    ...
                    <div className='w-full md:max-w-[450px] mt-1 flex flex-col gap-1'>
                        <label className='text-tertiary font-normal text-base'>Repassword</label>
                        <input type='password' name='rePassword' value={formikRegister.values.rePassword} onBlur={formikRegister.handleBlur} onChange={formikRegister.handleChange} className='w-full bg-primary rounded-md border-[1px] border-gray-50 px-2 py-1' placeholder='Repassword'/>
                    ...
                    <div className='w-full md:max-w-[450px] mt-1 flex flex-col gap-1'>
                        <label className='text-tertiary font-normal text-base'>Phone</label>
                        <input type='tel' name='phone' value={formikRegister.values.phone} onBlur={formikRegister.handleBlur} onChange={formikRegister.handleChange} className='w-full bg-primary rounded-md border-[1px] border-gray-50 px-2 py-1' placeholder='Phone'/>
                        {formikRegister.errors.phone && formikRegister.touched.phone && <div className='text-red-500'>*{formikRegister.errors.phone}</div>}
                    </div>

                    <button type='submit' className='cursor-pointer mt-3 block w-full md:max-w-[450px] px-2 py-1 bg-tertiary text-white rounded-md'>Sing Up</button>
                ...
                {showLogin &&  <form onSubmit={formikLogin.handleSubmit} className='mt-3'>
                    ...
                    <div className='w-full md:max-w-[450px] mt-1 flex flex-col gap-1'>
                        <label className='text-tertiary font-normal text-base'>Email</label>
                        <input type='email' name='email' value={formikLogin.values.email} onBlur={formikLogin.handleBlur} onChange={formikLogin.handleChange} className='w-full bg-primary rounded-md border-[1px] border-gray-50 px-2 py-1' placeholder='Email'/>
                        {formikLogin.errors.email && formikLogin.touched.email && <div className='text-red-500'>*{formikLogin.errors.email}</div>}
                    </div>

                    <div className='w-full md:max-w-[450px] mt-1 flex flex-col gap-1'>
                        <label className='text-tertiary font-normal text-base'>Password</label>
                        <input type='password' name='password' value={formikLogin.values.password} onBlur={formikLogin.handleBlur} onChange={formikLogin.handleChange} className='w-full bg-primary rounded-md border-[1px] border-gray-50 px-2 py-1' placeholder='Password'/>
                        {formikLogin.errors.password && formikLogin.touched.password && <div className='text-red-500'>*{formikLogin.errors.password}</div>}
                    </div>
                    {errorMsg && <div className='text-red-500'>*{errorMsg}</div>}
                    <button type='submit' className='cursor-pointer mt-3 block w-full md:max-w-[450px] px-2 py-1 bg-tertiary text-white rounded-md'>Login</button>
